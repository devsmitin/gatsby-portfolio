    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          <Title>About</Title>
          <AboutHero>
            <Avatar src={avatar} alt="Smit Modi" />
            <AboutSub>
              Seriously speaking I dont know what I should write here, but it has to be something. So I am writing this nonsense. It could waste some of your time, maybe 1 or 2 minutes. Calculating this minutes of every person who read this, I would have waste tens' of hours collectively. But I dont care you know... Peace :)
            </AboutSub>
          </AboutHero>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={4}>
        <Inner>
          ...
          <ContactText>
            Say <a href="mailto:aquarocker20@gmail.com">Hi</a> or find me on other platforms:{' '}
            <a href="https://www.instagram.com/smiling.smit/">Instagram</a> &{' '}
            <a href="https://www.facebook.com/smiling.smit/">Facebook</a>
          </ContactText>
        </Inner>
        <Footer>
          &copy; 2018 Template by Gatsby Starter Portfolio Cara.
        </Footer>
      </Content>
